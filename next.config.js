...
const envVars = {
  env: {
    NEXT_PUBLIC_NODE_SERVER_URL: process.env.NEXT_PUBLIC_NODE_SERVER_URL || "http://localhost:3033",
    NEXT_PUBLIC_AniTrek_SERVER_URL: process.env.NEXT_PUBLIC_AniTrek_SERVER_URL || "http://localhost:3034",
