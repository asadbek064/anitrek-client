...
import AiSwiperCard from "./AiSwiperCard";
  ...
  interface CardSwiperProps {
    ...
    onEachCard?: (data: ExperimentAnimeTitles) => React.ReactNode;
  }
  ...
  const AiCardSwiper: React.FC<CardSwiperProps> = (props) => {
    const {
      data,
      onEachCard = (data, isHover) => (
        <AiSwiperCard isExpanded={isHover} data={data} />
      ),
    } = props;
  ...
  export default React.memo(AiCardSwiper);
