...
const DeletionPrivacy = () => {
  return (
    <Section className="space-y-8 pt-20">
      <Head title="Privacy - AnimeOnline" />

      <h1>Privacy Policy for AnimeOnline</h1>

      <p>
        At AnimeOnline, accessible from https://AnimeOnline.live, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by AnimeOnline
        and how we use it.
      </p>
      ...
      <p>
        AnimeOnline legal basis for collecting and using the personal information
      ...
      <ul>
        <li>AnimeOnline needs to perform a contract with you</li>
        <li>You have given AnimeOnline permission to do so</li>
        <li>
          Processing your personal information is in AnimeOnline legitimate interests
        </li>
        <li>AnimeOnline needs to comply with the law</li>
      </ul>

      <p>
        AnimeOnline will retain your personal information only for as long as is
      ...
      <p>
        AnimeOnline follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, AnimeOnline uses &apos;cookies&apos;. These cookies
      ...
      <p>
        ...
        advertising partners of AnimeOnline.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on AnimeOnline, which are sent directly
      ...
      <p>
        Note that AnimeOnline has no access to or control over these cookies that are
      ...
      <p>
        AnimeOnline&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        AnimeOnline does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in AnimeOnline. This policy is not applicable to any
