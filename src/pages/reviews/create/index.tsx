...
const ChooseTitleToReview = () => {
    ...
    return (
      <Section className="py-20">
        ...
        <h1 className="[font-size:var(--step-3)] font-semibold mb-8">
        ...
        {!isLoading ? (
          <React.Fragment>
            <List data={totalData}>
              {(data) => (
                <Card data={data} redirectUrl={`/reviews/create/${data.id}`} />
              )}
            </List>
  ...
  export default ChooseTitleToReview;